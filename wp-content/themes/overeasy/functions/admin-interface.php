...
//Remote
$theme_data = get_theme_data('http://www.woothemes.com/demo/'.$theme_folder.'/wp-content/themes/'.$theme_folder.'/style.css');
$remote_version = $theme_data['Version'];

// Version Checking and Message generator
if ($remote_version == $local_version) {
    $update_message = '<span class="update">v.'. $local_version .'</span>';
} else {
    $update_message = '<span class="update">v.'. $local_version .' <a href="'. $manualurl .'/#changelog">(Update Available)</a></span></span>';
}
